...
public class PropertiesComparator {
	...
	public static CompareResults compare(final Properties left, final Properties right) {
		...
		final Set<String> removedKeys = new HashSet<>(leftKeys);
		...
		final Set<String> addedKeys = new HashSet<>(rightKeys);
		...
		final Set<String> commonKeys = new HashSet<>(leftKeys);
		commonKeys.retainAll(rightKeys);
		final Set<String> modifiedKeys = new HashSet<>();
		...
		final Map<String, List<String>> differentValues = new TreeMap<>();
		for (final String modifiedKey : modifiedKeys) {
			final ArrayList<String> values = new ArrayList<>(2);
